...
1. **Clone the repository**:
   ...
   ```bash
   git clone git@github.com:sandeepjaat12084-prog/Porfolio.git
   cd Porfolio
   ```
...
- **Priyanshu Gupta** ([@priyanshuguptcoder](https://github.com/priyanshuguptcoder)) — Contributor & Design Architecture
